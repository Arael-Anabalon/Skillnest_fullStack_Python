...
# Error: hay una función inexistente
...
# (ninguna) | 
# Salida: 12
# El print(15) es código inalcanzable (está abajo de un return).
...
# a b       | 3 - 4
# Salida: 365 - 12 - 377
# El return fuera de las condicionales no se ejecuta, pues las condicionales devuelven un valor con un return
...
# b         | 4 
# Salida: 7
# El 2do return no se ejecuta porque el return arriba de este ya devuelve un valor y rompe su codigo
