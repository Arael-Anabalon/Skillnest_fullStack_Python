...
VALUES
("randy123", "randy123", "randy@gmail.com", 2),
...
VALUES
("Hola, esto es un comentario!", 1, 2),
("Hola soy la Teteee admin", 3, 3);

SELECT * FROM comentarios;

-- Mostrar mensajes dodne el remitente sea randy:
SELECT contenido, emisor
FROM mensajes
WHERE emisor = 1;

-- Mostrar usuarios que estan eliminados (Deleted = 0):
